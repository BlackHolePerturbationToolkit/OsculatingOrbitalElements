...
Module[{k, RHSE,RHSL,RHSK,RHSpsir,RHSpsi\[Theta],RHS\[Phi],ft, fr, f\[Theta], f\[Phi], \[Lambda], En, L, K, \[Psi]r, \[Psi]\[Theta], t, \[Phi],
        ...
        progress = 0, limit, Vr,r1, r2, r, \[Beta],Q, zm, zp, \[CapitalSigma], \[CapitalSigma]1, \[CapitalSigma]2, \[CapitalDelta], \[CapitalDelta]1, \[CapitalDelta]2, \[Omega], F, F1, F2, H, \[Theta], \[Kappa]1, \[Kappa]2, z, Q1, Q2,C,\[ScriptCapitalD],\[Epsilon], J, P, G, ur, u\[Theta], utup, u\[Phi]up, ut, u\[Phi], un, uztup, uz\[Phi]up, uzt, an,A1, A2, A3, dEd\[Lambda], dLd\[Lambda], dKd\[Lambda], d\[Psi]rd\[Lambda], d\[Psi]\[Theta]d\[Lambda], Eqns, \[Alpha],dtd\[Lambda],d\[Phi]d\[Lambda],frVal,f\[Phi]Val,f\[Theta]Val},
Needs["KerrGeodesics`"];
...
}/.{En-> En[t], L->L[t],K->k[t],\[Psi]r->\[Psi]r[t],\[Psi]\[Theta]->\[Psi]\[Theta][t],\[Phi]->\[Phi][t]});
...
If[OptionValue["TimeMonitor"]==True, Print["Starting NDSolve..."];
    limit = OptionValue["IntegrationLimit"];
